...
from .models import ChatSession, Message, ServiceRequest, DiagnosticLog, KnowledgeBaseArticle, Product, KnownVisualIssue
...
class ServiceRequestAdmin(admin.ModelAdmin):
    list_display = ('name', 'phone', 'service_time', 'brand', 'model_number', 'status', 'status_badge', 'created_at')
    list_filter = ('status', 'brand', 'desired_date', 'created_at')
    ...
    def service_time(self, obj):
        ...
        return "Not Set"
    service_time.short_description = 'Booking Date/Time'
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('name', 'category', 'price_estimate')
    list_filter = ('category',)
